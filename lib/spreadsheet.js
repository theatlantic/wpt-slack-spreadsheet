...
const formatResults = (sheet, cb) => {
  const data = waterfallResults.data;
  ...
  const spreadsheetData = Object.assign({}, obj, waterfallResults.psi);
  cb(null, sheet, spreadsheetData);
};
